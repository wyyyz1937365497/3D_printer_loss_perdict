...
from transformer_model import TransformerDisplacementPredictor
...
def train_transformer_model():
    ...
    # 初始化Transformer模型
    model = TransformerDisplacementPredictor(
    ...
    model_path = os.path.join(models_dir, 'transformer_displacement_predictor.pth')
    torch.save(model.state_dict(), model_path)
    
    scaler_x_path = os.path.join(models_dir, 'transformer_scaler_X.pkl')
    scaler_y_path = os.path.join(models_dir, 'transformer_scaler_y.pkl')
    ...
    # 保存可视化结果
    vis_path = os.path.join(models_dir, 'transformer_training_results.png')
...
if __name__ == "__main__":
    model, X_scaler, y_scaler = train_transformer_model()